"""
Echodataflow Add Location Task

This module defines a Prefect Flow and associated tasks for the Echodataflow Add Location Task.
...
def echodataflow_add_location(
    ...
    Example:
        ...
        # Execute the Echodataflow add location stage
        loc_output = echodataflow_add_location(
