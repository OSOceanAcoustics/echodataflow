"""
Module containing the Singleton_Echodataflow class and utility methods.

This module defines the `Singleton_Echodataflow` class, which implements a Singleton
pattern for managing echodataflow-related configurations, logging, and database operations.
It also provides utility methods for logging, managing processes, inserting log data,
and logging memory usage.

Classes:
    Singleton_Echodataflow: Singleton class for managing echodataflow configurations and operations.

Functions:
    - get_instance(self) -> "Singleton_Echodataflow": Get the instance of Singleton_Echodataflow.
    ...
    - setup_echodataflow_db(self): Setup the echodataflow database and return a DB_Log instance.
...
from echodataflow.utils.databse_utils import (
    create_log_table,
    get_connection,
    get_last_log,
...
class Singleton_Echodataflow:
    ...
    @classmethod
    def get_instance(self) -> "Singleton_Echodataflow":
        """
        Get the instance of the Singleton_Echodataflow class.
