...
df_raw = pd.read_csv(
    "/Users/wujung/code_git/echodataflow/temp_raw/SH2306_raw_files.txt",
...
def copy_raw_files():
    ...
    local_path = f"/Users/wujung/code_git/echodataflow/temp_raw/SH2306/{filename}"
...
if __name__ == "__main__":
    ...
    deploy(
        copy_raw_files.from_source(
            ...
            entrypoint="example.py:copy_raw_files"
        ).to_deployment(
            name="copy-raw-files",
            work_pool_name="local",
        ...
        flow_2.from_source(
            source=str(Path(__file__).parent),
            entrypoint="example.py:flow_2"
        ).to_deployment(name="flow_2-deploy"),
        flow_3.from_source(
            source=str(Path(__file__).parent),
            entrypoint="example.py:flow_3"
